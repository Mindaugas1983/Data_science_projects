...
def print_results(scores,metrics = 2):
    ...
    '''
    This function prints results cross-validation function in convienient format 
    Parameters:
    ...
    if(metrics == 1):
        print("Log_loss")
        print("average test score: ",   np.average(scores["test_score"]), " average train score: ",np.average(scores["train_score"]))
        print("minimum test score: ", np.min(scores["test_score"]), "minimum train score: ", np.min(scores["train_score"]))
        print("maximum test score: ", np.max(scores["test_score"]), "maximum train score: ", np.max(scores["train_score"]))
        ...
        print("RMSE")
        print("average test score: ",   np.average(scores["test_neg_mean_squared_error"]), " average train score: ",np.average(scores["train_neg_mean_squared_error"]))
        print("minimum test score: ", np.min(scores["test_neg_mean_squared_error"]), "minimum train score: ", np.min(scores["train_neg_mean_squared_error"]))
        print("maximum test score: ", np.max(scores["test_neg_mean_squared_error"]), "maximum train score: ", np.max(scores["train_neg_mean_squared_error"]))
        print("std test score: ", np.std(scores["test_neg_mean_squared_error"]), " std train score: ", np.std(scores["train_neg_mean_squared_error"]))
        ...
        print("AUC")
        print("average test score: ",   np.average(scores["test_roc_auc"]), " average train score: ",np.average(scores["train_roc_auc"]))
        print("average test gini score: ",   np.average(scores["test_roc_auc"]*2 -1), " average train gini score: ",np.average(scores["train_roc_auc"]* 2 - 1))
        print("minimum test score: ", np.min(scores["test_roc_auc"]), "minimum train score: ", np.min(scores["train_roc_auc"]))
        print("maximum test score: ", np.max(scores["test_roc_auc"]), "maximum train score: ", np.max(scores["train_roc_auc"]))
        print("std test score: ", np.std(scores["test_roc_auc"]), " std train score: ", np.std(scores["train_roc_auc"]))
        print("std gini test score: ", np.std(scores["test_roc_auc"]*2 -1), " std gini train score: ", np.std(scores["train_roc_auc"]*2 -1))
        ...
        print(" ")
        print("Log_loss")
        print("average test score: ",   np.average(scores["test_neg_log_loss"]), " average train score: ",np.average(scores["train_neg_log_loss"]))
        print("minimum test score: ", np.min(scores["test_neg_log_loss"]), "minimum train score: ", np.min(scores["train_neg_log_loss"]))
        print("maximum test score: ", np.max(scores["test_neg_log_loss"]), "maximum train score: ", np.max(scores["train_neg_log_loss"]))
        print("std test score: ", np.std(scores["test_neg_log_loss"]), " std train score: ", np.std(scores["train_neg_log_loss"]))
...
def plot_capcurve(y_values, y_preds_proba):
    ...
    ax2.plot([0, percent], [val, val], color='green', linestyle='--', linewidth=1, label=str(val*100)+'% of positive obs at '+str(percent*100)+'%')
